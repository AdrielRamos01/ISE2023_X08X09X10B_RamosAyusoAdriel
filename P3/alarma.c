...
//PARPADEO DE LED VERDE AL SALIR DEL MODO BAJO CONSUMO
...
int Init_Timer_LowPower (void) {

  // Create periodic timer
  exec3 = 1U;
  tim_id3 = osTimerNew((osTimerFunc_t)&Timer3_Callback, osTimerPeriodic, &exec3, NULL);
  osTimerStart(tim_id3, 250U);   
